...
const DETAILS = {
  ...
  expedition: "Inspect or resume the current Expedition and accept validated mapper reports.",
...
const USAGE = {
  ...
  expedition: "charthouse expedition <status [id]|resume [id]|accept-report <id> --role <role> --file <path>>",
